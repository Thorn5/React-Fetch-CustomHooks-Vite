...
export const UseAsyncAwaitTestServer = () => {
  ...
  //     "color: #35e859"
  //   );
  //   console.log("Server Product", AA_productModuleCalled, AA_productData);
  //   console.log("Server Customer", AA_cusomerModuleCalled, AA_customerData);
  //   console.log(
  //     "%c*+*+*+*+*+*+ /API useEffect diagnostics/ *+*+*+*+*+*+",
  //     "color: #35e859"
  //   );
  // }, [
  //   AA_productModuleCalled, AA_productData, AA_customerData,
  // ]);
